  ...
  return (
    <div style={{
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 20px" }}>
            ...
            <div>
              {loading && (
                <div style={{ textAlign: "center", padding: "80px 20px", background: "white", borderRadius: "20px", border: "1px solid #FFD4C2" }}>
                  ...
                  <p style={{ fontSize: "15px", fontWeight: 600, color: "#3D1A0A", marginBottom: "4px" }}>Analyzing your message...</p>
          ...
          {activeTab === "tasks" && (
            <div>
              ...
              <TaskList refreshTrigger={refreshTrigger} showOnly="tasks" />
            </div>
          )}
          ...
          {activeTab === "calendar" && (
            <div>
              <h2 style={{ fontFamily: "'Syne'", fontSize: "20px", fontWeight: 800, color: "#3D1A0A", marginBottom: "20px" }}>📅 Calendar Events</h2>
          ...
          {activeTab === "history" && (
            <div>
              <h2 style={{ fontFamily: "'Syne'", fontSize: "20px", fontWeight: 800, color: "#3D1A0A", marginBottom: "20px" }}>🕒 Recent History</h2>
      ...
      <div style={{
        ...
        <span style={{ fontSize: "12px", color: "#C4826A" }}>
          © 2025 Intent Engine
        </span>
        <span style={{ fontSize: "12px", color: "#C4826A" }}>
